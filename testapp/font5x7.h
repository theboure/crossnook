/* Auto-generated by testapp/make_font.py. Do not edit by hand. */
/* 5x7 bitmap font, 1 byte per row (7 rows), bit4 = leftmost col. */
/* FONT5X7[i] = glyph for ASCII (i + 32); undefined chars are blank. */
const unsigned char font5x7[][7] = {
    ...
    /* 0x5f _ */ {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
/* 95 glyphs cover ASCII 32..126. */
enum { FONT_START = 32, FONT_NGLYPHS = 95 };
